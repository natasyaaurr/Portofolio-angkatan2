...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="depan/css/vendor.css">
    <link rel="stylesheet" href="depan/css/styles.css">

    <!-- favicons
    ================================================== -->
    <link rel="apple-touch-icon" sizes="180x180" href="depan/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="depan/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="depan/favicon-16x16.png">
    <link rel="manifest" href="depan/site.webmanifest">
...
<body id="top">
            ...
            <section id="contact" class="s-contact target-section">
                ...
                <div class="row contact-bottom">
                    ...
                    <div class="column lg-4 md-12 contact-block">
                        <a href="mailto:sayhello@luther.com"
    ...
    <!-- Java Script
    ================================================== -->
    <script src="depan/js/plugins.js"></script>
